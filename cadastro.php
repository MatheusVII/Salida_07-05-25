  ...
  <body class=" h-100">
    ...
    <main class="d-flex align-itens-center mx-auto form-container bg-light border border-tertiary rounded-3 shadow-sm">
        <form action="acoes.php" method="post">
            <h1 class="d-flex h3 justify-center mb-3 fw-normal">Cadastro</h1>
            <?php if (isset($_SESSION['cadastro_erro'])): ?>
                <div class="alert alert-danger" role="alert">
                    <?= $_SESSION['cadastro_erro']; ?>
                </div>
                <?php unset($_SESSION['cadastro_erro']); // Remove a mensagem após exibi-la ?>
                <?php endif; ?>
            ...
            <div class="form-floating mb-3">
                <input name="telefone" type="text" class="form-control" id="floatingInput" placeholder="Telefone" required maxlength="15" onkeyup="this.value = formatarTelefone(this.value)">
    ...
    <script>
        ...
        function formatarTelefone(telefone) {
            ...
            telefone = telefone.replace(/(\d{4})(\d)/, '$1-$2'); // Formata o número
            return telefone;
        }
    </script>
